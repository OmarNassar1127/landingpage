    ...
    <section className="py-12 md:py-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <div className="inline-flex items-center gap-6 md:gap-8 bg-gradient-to-r from-primary/5 via-background to-purple-500/5 border border-primary/20 rounded-2xl px-6 md:px-8 py-4 md:py-6 backdrop-blur-sm">
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-primary text-white dark:text-black rounded-xl px-4 py-2 shadow-lg">
            ...
            <div className="text-left">
              <motion.h3
                ...
                className="text-lg md:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-1"
              >
